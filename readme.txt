...
Plugin URL:
Tags:  mpesa, m-pesa, woocommerce, mpesa api, gateway, Mobile Payments, mpesa online, Vodacom,  Mpesa API Mozambique, Payments, PaymentsDS
...
Adiciona Mpesa como método de pagamento ao WooCommerce.
...
* Visite a nossa sessão de [Perguntas Frequentes]().
* Utilize o nosso fórum no [Github](https://github.com/paymentsds/mpesa-wp-plugin/issues).
* Crie um tópico no [fórum de ajuda do WordPress]().
